...
<body>
	...
	<p>
		Applicable for
		<%=Constants.getInfo().getTitle()%>
		and all associated websites, services, software, documentation and
		downloadable files (hereafter referred to as <strong>Application</strong>),
		which provides the SERVICE.
	</p>

	<p>This page is used to inform Application users regarding our
		policies with the collection, use, and disclosure of Personal
		Information if anyone decided to use our Service and the Application.</p>
	...
	<p>
		...
		Terms and Conditions, which is accessible <a href="license.jsp">here</a>,
	...
	<p>Cookies are files with small amount of data that is commonly
	...
	<p>Application may use these "cookies" to collection information
	...
	<p>We want to inform our Service users that these third parties
	...
	<p>Our Services do not address anyone under the age of 18. We do
		not knowingly collect personal identifiable information from minors
		under 18. In the case we discover that a minor under 18 has provided
		us with personal information, we immediately delete this from our
		servers. If you are a parent or guardian and you are aware that your
		ward has provided us with personal information, please contact us so
	...
	<p>
		...
		not hesitate to contact us (<%=Constants.getInfo().getContact()%>).
	</p>
	<p>&nbsp;</p>
</body>
</html>