...
<body>
	...
	<p>"Contributor" shall mean Licensor and any individual or Legal
		...
		and subsequently incorporated within the Work.</p>
	...
	<ol>
		...
		<li>You must retain, in the Source form of any Derivative Works
			...
			notices that do not pertain to any part of the Derivative Works; and</li>
		<li>If the Work includes a "NOTICE" text file as part of its
			...
			construed as modifying the License.</li>
	</ol>
	...
	<p>While redistributing the Work or Derivative Works thereof, You
	...
	<p>
		<strong>APPENDIX: How to apply the Apache License to your
			work</strong>
	</p>
